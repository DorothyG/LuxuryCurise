 ...
 */
@Entity
@Table(name = "room_month_revenue")
public class RoomMonthRevenue {
    ...
    public RoomMonthRevenue() {
    }

    public RoomMonthRevenue(int id, int curise_id, double revenue, String collator, String date) {
        this.id = id;
