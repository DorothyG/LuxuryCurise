<%-- 
    Document   : indexBackground
    Created on : 2016-10-31, 12:23:58
    Author     : Apple
--%>
        ...
        <div id="top">
            ...
            <div id="login" class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="loginState">
                    ...
                    <li>
                        <a id="logout">退出</a>
                        <form id="lo" action="/LuxuryCurise/logout", method="post"></form>
                    </li>
                </ul>
            </div>
        </div>
