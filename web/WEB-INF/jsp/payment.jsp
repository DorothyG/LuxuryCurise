<%-- 
    Document   : payment
    Created on : 2016-10-22, 12:03:37
    Author     : Apple
--%>
...
<html>
    ...
    <body ng-controller="payment">
        ...
        <div id="curiseInfo">
            <label id="curiseName" ng-bind="payment.curise_name"></label>
            <div class="cabin">
                <label>总舱位：
                    <span class="text-info" ng-bind="payment.total_rooms"></span>
                </label>
                &nbsp;&nbsp;
                <label>已缴费：
                    <span class="text-success" ng-bind="payment.paid"></span>
                </label>
                &nbsp;&nbsp;
                <label>未缴费：
                    <span class="text-warning" ng-bind="payment.unpaid"></span>
                </label>
            </div>
        ...
        <div class="panel-group" id="layerInfo">
            <div class="panel panel-default" ng-repeat="x in payment.layerPayments">
                <!--层数信息-->
                <div class="panel-heading">
                    <h4 class="panel-title">
                        ...
                        <div class="layer text-muted">
                            ...
                            &nbsp;&nbsp;
                            <label>已缴费：
                                <span class="text-success" ng-bind="x.paid"></span>
                            </label>
                            &nbsp;&nbsp;
                            <label>未缴费：
                                <span class="text-warning" ng-bind="x.unpaid"></span>
                            </label>
                        </div>
                ...
                <div id="layer{{x.layer}}" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <span ng-repeat="y in x.roomTypePayments">
                            <a ng-if="y.room_type == '内舱房' && y.isPaid == '未缴费'" class="btn btn-info color" data-toggle="modal" data-target="#myModal">
                                <p ng-bind="y.room_type"></p>
                                <h3 ng-bind="y.room_name"></h3>
                                <p ng-bind="y.isPaid"></p>
                            </a>
                            <a ng-if="y.room_type == '套房' && y.isPaid == '未缴费'" class="btn btn-primary color" data-toggle="modal" data-target="#myModal">
                                <p ng-bind="y.room_type"></p>
                                <h3 ng-bind="y.room_name"></h3>
                                <p ng-bind="y.isPaid"></p>
                            </a>
                            <a ng-if="y.room_type == '海景房' && y.isPaid == '未缴费'" class="btn btn-success color" data-toggle="modal" data-target="#myModal">
                                <p ng-bind="y.room_type"></p>
                                <h3 ng-bind="y.room_name"></h3>
                                <p ng-bind="y.isPaid"></p>
                            </a>
                            <a ng-if="y.room_type == '阳台房' && y.isPaid == '未缴费'" class="btn btn-warning color" data-toggle="modal" data-target="#myModal">
                                <p ng-bind="y.room_type"></p>
                                <h3 ng-bind="y.room_name"></h3>
                                <p ng-bind="y.isPaid"></p>
                            </a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-inline" name="resrve" method="post">
                            ...
                            <input class="form-control" name="amount" type="text" size="25">
                            <br/><br/>
                            <label for="name">已交押金：
                                <span class="text-info" id="paid" ng-bind="pay.paid_deposit"></span></label>
                            <br/><br/>
                            <label for="name">应付金额：
                                <span class="text-info" id="shouldpay" ng-bind="pay.should_pay"></span></label>
                            <br/>
                            <table class="table table-hover table-bordered table-striped" style="text-align:center;"> 
                                ...
                                <tbody>
                                    <tr ng-repeat="z in pay.userConsumptions">
                                        <th ng-bind="z.place"></th>
                                        <th ng-bind="z.consume_type"></th>
                                        <th ng-bind="z.time"></th>
                                        <th ng-bind="z.amount"></th>
                                    </tr>
                                    <!--                                    <tr>
                                                                            <th>餐饮部</th>
                                                                            <th>法式大餐</th>
