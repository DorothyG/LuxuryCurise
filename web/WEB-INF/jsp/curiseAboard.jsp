<%-- 
    Document   : curiseAboard
    Created on : 2016-10-22, 11:58:40
    Author     : Apple
--%>
...
<html>
    ...
    <body>
        ...
        <div ng-controller="curiseAboard">
            <div id="curiseInfo">
                <label id="curiseName" ng-bind="curiseAboard.curise_name"></label>
                <div class="cabin">
                    <label>总舱位：
                        <span class="text-info" ng-bind="curiseAboard.total_rooms"></span>
                    </label>
                    &nbsp;&nbsp;
                    <label>已预订：
                        <span class="text-warning" ng-bind="curiseAboard.reserved"></span>
                    </label>
                    &nbsp;&nbsp;
                    <label>剩余：
                        <span class="text-success" ng-bind="curiseAboard.remainder"></span>
                    </label>
                    &nbsp;&nbsp;
                    <label>入住：
                        <span class="text-danger" ng-bind="curiseAboard.checked_in"></span>
                    </label>
                </div>
                <a data-toggle="collapse" id="all" data-target=".panel-collapse">展开全部<i class="icon-angle-down"></i></a>
            </div>

            <div class="panel-group layerInfo">
                <!--第一层-->
                <div class="panel panel-default" ng-repeat="x in curiseAboard.layerReserves">
                    <!--层数信息-->
                    ...
                    <!---------->
                    <div id="layer{{x.layer}}" class="panel-collapse collapse in" data-target="#all">
                        <div class="panel-body">
                            <span ng-repeat="y in x.roomTypeLayerReserves">
                                <a ng-if="y.room_type == '内舱房' && y.check_in_state == '待入住'" class="btn btn-info color" data-toggle="modal" data-target="#myModal">
                                    <p ng-bind="y.room_type"></p>
                                    <h3 ng-bind="y.room_name"></h3>
                                    <p ng-bind="y.check_in_state"></p>
                                </a>
                                <a ng-if="y.room_type == '套房' && y.check_in_state == '待入住'" class="btn btn-primary color" data-toggle="modal" data-target="#myModal">
                                    <p ng-bind="y.room_type"></p>
                                    <h3 ng-bind="y.room_name"></h3>
                                    <p ng-bind="y.check_in_state"></p>
                                </a>
                                <a ng-if="y.room_type == '海景房' && y.check_in_state == '待入住'" class="btn btn-success color" data-toggle="modal" data-target="#myModal">
                                    <p ng-bind="y.room_type"></p>
                                    <h3 ng-bind="y.room_name"></h3>
                                    <p ng-bind="y.check_in_state"></p>
                                </a>
                                <a ng-if="y.room_type == '阳台房' && y.check_in_state == '待入住'" class="btn btn-warning color" data-toggle="modal" data-target="#myModal">
                                    <p ng-bind="y.room_type"></p>
                                    <h3 ng-bind="y.room_name"></h3>
                                    <p ng-bind="y.check_in_state"></p>
                                </a>
                                <!--                                <span ng-switch="y.room_type && y.check_in_state">
                                                                    <a ng-switch-when="待入住" class="btn btn-info color" data-toggle="modal" data-target="#myModal">
                                                                        <p ng-bind="y.room_type"></p>
                                                                        <h3 ng-bind="y.room_name"></h3>
                                                                        <p ng-bind="y.check_in_state"></p>
                                                                    </a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-inline" name="curise_aboard" method="post">
                            ...
                            <input class="form-control" name="ID_number"  type="text" size="25">
                            <br/><br/>
                            ...
                            <input class="form-control"name="phone_number" type="text" size="25">
                            <br/><br/>
                            <label for="name">登船时间：
